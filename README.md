****************************
Original ElecSus project at https://github.com/jameskeaveney/ElecSus

The NewMethod, Optimization and Plotting folders contain files created during the course of my project. NewMethod files have been added to elecsus/libs/ and the elecsus_methods file has been edited to use the new calculation methods.
